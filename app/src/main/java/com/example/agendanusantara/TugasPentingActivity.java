...
public class TugasPentingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tugas_penting);
        ...
        tombolSimpan = findViewById(R.id.btn_simpan);
        ...
        inputTanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TugasPentingActivity.this,
        ...
        tombolSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (judul.isEmpty() || tgl.isEmpty()) {
                    Toast.makeText(TugasPentingActivity.this, "Judul dan Tanggal wajib diisi!", Toast.LENGTH_SHORT).show();
                } else {
                    // Panggil fungsi database, kategori disetel manual ke "Penting"
                    db.addTugas(judul, desk, tgl, "Penting");
